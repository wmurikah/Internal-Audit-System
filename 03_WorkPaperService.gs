...
function createWorkPaper(data, user) {
  ...
  const workPaper = {
    ...
    control_objectives: sanitizeInput(data.control_objectives || '') || null,
    control_classification: data.control_classification || null,
    control_type: data.control_type || null,
    control_frequency: data.control_frequency || null,
    control_standards: sanitizeInput(data.control_standards || '') || null,
